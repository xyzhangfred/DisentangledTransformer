...
from probing_util import InputExample, InputFeaturesNL, convert_examples_to_features_NL, prepare,\
                         batcher, probe
...
PATH_TO_SENTEVAL = '/home/xiongyi/dataxyz/repos/SentEval/'
...
def read_Probe_examples(input_file):
    ...
    for i,line in enumerate(lines):
        label_str = line[1].lower()
        if label_str in label2num.keys():
...
def convert_examples_to_features(examples, tokenizer, max_seq_length):
    ...
    for example_index, example in enumerate(examples):
        ...
        _truncate_seq_pair(sent_tokens, [], max_seq_length - 2)
...
def main(finetuning_task = 'word_content'):
    ...
    parser.add_argument('--gradient_accumulation_steps',
                        type=int,
                        default=1,
                        help="Number of updates steps to accumulate befolabel_numre performing a backward/update pass.")
